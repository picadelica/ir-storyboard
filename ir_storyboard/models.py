        ...
        subsections=[
            ...
            SubsectionSpec("2.3", "COFOUNDER_DYNAMICS", "Co-founder dynamics",
                           description=(
                               ...
                               "достижения и знания получил в рамках пути в этой компании? Что драйвит "
                               "именно в этой компании? Какая мотивация в этой компании? НЕ сюда: вся "
                               "команда в целом (L4)."
                           ),
                           sort_order=3),
        ],
        ...
        subsections=[
            ...
            SubsectionSpec("3.2", "SHARED_LIFE", "Shared life",
                           description=(
                               ...
                               "события и ритуалы. НЕ сюда: процессы и принципы найма (L3.1), внешний "
                               "культурный контекст компании (L8.1)."
                           ),
                           sort_order=2),
