...
LAYERS: List[LayerSpec] = [
        ...
        subsections=[
            ...
            SubsectionSpec("1.2", "VALUES_BELIEFS", "Values & Beliefs",
                           description=(
                               ...
                               "(L1.3), а также бизнес-философия продукта (L6.1)."
                           ),
                           sort_order=2),
            SubsectionSpec("1.3", "FEARS_DREAMS_IDENTITY", "Fears, Dreams & Identity",
                           description=(
                               ...
                               "НЕ сюда: декларируемые принципы и мировоззрение (L1.2), обоснование "
                               "выбора именно этого стартапа (L2.2)."
                           ),
                           sort_order=3),
        ],
    ),
    LayerSpec(
        ...
        subsections=[
            SubsectionSpec("2.1", "PATH_TO_EXPERTISE", "Path of expertise",
                           description=(
                               ...
                               "степени, профильные исследования. Также про обучение: какие курсы "
                               "проходил, в каких вузах учился. Основные достижения и ошибки в "
                               "профессиональном пути. О чём жалеет в профессиональном плане. Что "
                               "мотивировало учиться и развиваться? Какие были принципы в пути? Сюда — "
                               "особенности решений в предыдущих продуктах. НЕ сюда: достижения и путь "
                               "в текущей компании (той, что в названии профиля) — это L6.3."
                           ),
                           sort_order=1),
            SubsectionSpec("2.2", "FOUNDER_ROLE_MOTIVATION", "Founders & Core team relations",
                           description=(
                               "Отношения с ко-фаундерами и командами в ПРЕДЫДУЩИХ компаниях: какие "
                               "роли были в прошлых компаниях, какие были отношения с фаундерами и с "
                               "командами, кто входил в предыдущие команды, как познакомился с прошлыми "
                               "ко-фаундерами и командой. НЕ сюда: общий карьерный путь (L2.1); текущая "
                               "команда (L3, L4)."
                           ),
                           sort_order=2),
            SubsectionSpec("2.3", "COFOUNDER_DYNAMICS", "Investors relations",
                           description=(
                               "Взаимоотношения с инвесторами в ПРЕДЫДУЩИХ компаниях: конкретные "
                               "ситуации, отношения, истории. НЕ сюда: взаимоотношения с текущими "
                               "инвесторами (L3.3)."
                           ),
                           sort_order=3),
        ],
    ...
    LayerSpec(
        ...
        subsections=[
            ...
            SubsectionSpec("3.2", "SHARED_LIFE", "Shared life",
                           description=(
                               "Общие события, ритуалы, культура сообщества ТЕКУЩЕЙ компании: что "
                               "объединяет, какие мероприятия, традиции, форумы, общая мифология. Сюда — "
                               "конкретные события и ритуалы в текущей компании. НЕ сюда: процессы и "
                               "принципы найма (L3.1), внешний культурный контекст компании (L8.1), "
                               "принципы найма в предыдущих компаниях (L2.2), взаимоотношения с "
                               "инвесторами в предыдущих компаниях (L2.3)."
                           ),
                           sort_order=2),
            SubsectionSpec("3.3", "INVESTORS_PARTNERS", "Investors & Partners",
                           description=(
                               "Структура инвесторов и стратегических партнёров ТЕКУЩЕЙ компании: кто, "
                               "когда вошёл, на каких условиях, чем помогают помимо денег. Сюда — раунды, "
                               "имена фондов и партнёров, их роль. По какому принципу выбираете "
                               "инвесторов? Что является ред-флагом при выборе инвестора или партнёра? "
                               "Какие есть истории с инвесторами? НЕ сюда: фаундер сам (L2), команда "
                               "(L4), инвесторы предыдущих компаний (L2.3)."
                           ),
                           sort_order=3),
        ],
    ),
        ...
        subsections=[
            SubsectionSpec("4.1", "EXPERTISE_DIVERSITY", "Expertise & Diversity",
                           description=(
                               ...
                               "фаундер (L2), процессы роста (L4.2), экспертиза в предыдущих командах (L2.2)."
                           ),
                           sort_order=1),
            SubsectionSpec("4.2", "GROWTH_TRANSFORMATION", "Growth & Transformation",
                           description=(
                               ...
                               "кризисы роста? НЕ сюда: состав на сейчас (L4.1), рост бизнеса и его "
                               "цифры (L6.3)."
                           ),
                           sort_order=2),
        ...
        subsections=[
            SubsectionSpec("6.1", "ARCHITECTURE_OF_SOLUTION",
                           ...
                           description=(
                               ...
                               "(L1.2), решения в предыдущих компаниях (L2.1)."
                           ),
                           sort_order=1),
            SubsectionSpec("6.2", "PHILOSOPHY_PRODUCT_DECISIONS", "Market context",
                           description=(
                               "Рыночный контекст: конкуренты и описание их решений, сдвиги на рынке, "
                               "история рынка и история возникновения проблемы/задачи, с которой рынок "
                               "работает. Эволюция рынка. НЕ сюда: отличия компании от рынка (L6.1)."
                           ),
                           sort_order=2),
