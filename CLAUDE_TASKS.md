...
> Прочитай этот файл целиком, потом выполняй задачи строго по порядку (Task 1 → 2 → 3 → 4).
...
Поведение:
- Выполняй Task 1 → 2 → 3 → 4 строго по порядку.
...
После ответа стартуй с Task 1 и не останавливайся, пока не дойдёшь до Task 4
